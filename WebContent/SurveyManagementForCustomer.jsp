...
%> <sj:tabbedpanel id="formTag"
	...
	<div id="frmSearch"><s:actionerror /> <s:form
		...
		<sj:datepicker label="Begin Time" name="beginTime" yearRange="1900" readonly="true"
			changeMonth="true" changeYear="true" cssClass="textfield"></sj:datepicker>
		<sj:datepicker label="End Time" name="endTime" yearRange="1900" readonly="true"
			changeMonth="true" changeYear="true" cssClass="textfield"></sj:datepicker>
		...
		<s:a href="Survey_managementForCustomer" cssClass="buttonAdd"
			cssStyle="padding:3px 12px; padding-top:5px; margin-left:15px;">Refresh</s:a>
	</s:form></div>

</sj:tabbedpanel> <s:form action="Survey_deleteManyOfCustomer" id="form">
	<ol>
		...
		<li><display:table id="survey" name="lstSurveyOfCustomer" pagesize="10"
			decorator="com.thuocdo.ma.Utils.SurveyDecorator" class="display"
			export="false" sort="list" requestURI="/Survey_managementForCustomer">
			...
			<display:column title="" url="/Survey_deleteOfCustomer" paramId="id"
